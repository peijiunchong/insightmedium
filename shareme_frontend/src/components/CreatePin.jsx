            ...
            <div className='flex flex-col'>
              <div>
                ...
                <select name="" id="" 
                  ...
                  className="outline-none w-4/5 text-base border-b-2 border-gray-200 p-2"
                >
                  <option value="other" className='bg-white'>Select Category</option>
                  {
                    categories.map((category, i) => (
                      <option value={category.name} key={i} className="text-base border-0 outline-none capitalize bg-white text-black">{category.name}</option>
                    ))
                  }
                </select>
              </div>
              <div className='flex justify-end items-end mt-5'>
                <button 
                  type='button' 
                  onClick={savePin} 
                  className="bg-red-500 text-white rounded-full p-2 w-28 font-bold"
                >
                  Save Pin
                </button>
              </div>
